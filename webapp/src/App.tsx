...
import { AirplaneFill, CartCheck, Coin, GraphUpArrow, HouseDoor } from 'react-bootstrap-icons'
  ...
  return (
    <Container fluid>
      ...
      <Row className='justify-content-center'>
        <ListPreview<Plane> Icon={CartCheck} header='Market' Component={PlaneListItem} items={Controllers.Planes.getAvailablePlanes()} />
        <ListPreview<HangarAsset> Icon={HouseDoor} header='Hangar' Component={HangarListItem} items={assets} />
      </Row>
    </Container>
  )
}
