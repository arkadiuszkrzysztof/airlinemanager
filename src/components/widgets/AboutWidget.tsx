  ...
  return (
    <Col xs={fullWidth ? 12 : 8} xl={fullWidth ? 12 : 6} xxl={fullWidth ? 10 : 5}>
      <Card className='p-0 m-2 widget-shadow' >
        ...
        <Card.Body className='d-flex flex-column mh-400 overflow-auto pt-0 pb-2 align-items-center' style={{ height: '320px' }}>
          <h2 className='text-primary my-4'>
            <AirplaneEnginesFill size={40} className='text-primary me-2 rotate-30'/>
          ...
          <div className='text-center'>
            ...
            <p className='fw-bold text-secondary mt-2'>@razuponatime</p>
          </div>
        </Card.Body>
      </Card>
    </Col>
