...
import { type DistanceUnits, GameController, type SpeedUnits } from '../../controllers/GameController'
  ...
  return (
    <Col xs={fullWidth ? 12 : 8} xl={fullWidth ? 12 : 6} xxl={fullWidth ? 10 : 5}>
      <Card className='p-0 m-2 widget-shadow' >
        ...
        <Card.Body className='d-flex flex-column align-items-center mh-400 overflow-auto pt-0 pb-2'>
